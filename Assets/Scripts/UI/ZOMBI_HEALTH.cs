...
public class Zombi_HEalth : MonoBehaviour
{
    public ZombieAI zombie; // сюда перетащи зомби
    ...
    {
        int toShow = zombie.IsDead ? 0 : Mathf.RoundToInt(percent * totalSegments);
